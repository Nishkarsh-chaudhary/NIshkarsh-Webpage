import{bt as e,xt as t,yt as n}from"./rsc.mjs";import{n as r,t as i}from"./arrow-up-right-C4HyjAT4.mjs";var a=t(e(),1),o=`# Product Delivery Case Studies
...
`,s=n(),c=[{slug:`move-my-stuff`,number:`01`,title:`Move My Stuff`},{slug:`koala-marketing-cloud`,number:`02`,title:`Koala Marketing Cloud`},{slug:`worksbuddy`,number:`03`,title:`Worksbuddy`},{slug:`ai-native-erp-pos`,number:`04`,title:`AI-Native ERP and POS`},{slug:`ai-office-analytics`,number:`05`,title:`AI Office Analytics`}],l=Array.from(o.matchAll(/^# 0[1-5] —[\s\S]*?(?=^---$)/gm),e=>e[0].trim());function u(e){return e.toLowerCase().replace(/[^a-z0-9]+/g,`-`).replace(/(^-|-$)/g,``)}function d(e){return e.split(/(\*\*[^*]+\*\*|`[^`]+`)/g).filter(Boolean).map((e,t)=>e.startsWith(`**`)?(0,s.jsx)(`strong`,{children:e.slice(2,-2)},t):e.startsWith("`")?(0,s.jsx)(`code`,{children:e.slice(1,-1)},t):(0,s.jsx)(a.Fragment,{children:e},t))}function f(e){let t=e.split(`
`),n=[];for(let e=0;e<t.length;){let r=t[e].trim();if(!r){e++;continue}let i=r.match(/^(#{1,4})\s+(.+)$/);if(i){let t=i[1].length,r=t>=3?u(i[2]):void 0,a=d(i[2]);n.push(t===1?(0,s.jsx)(`h2`,{children:a},e):t===2?(0,s.jsx)(`h3`,{children:a},e):(0,s.jsx)(`h4`,{id:r,children:a},e)),e++;continue}if(/^-\s+/.test(r)){let r=[];for(;e<t.length&&/^-\s+/.test(t[e].trim());)r.push(t[e++].trim().replace(/^-\s+/,``));n.push((0,s.jsx)(`ul`,{children:r.map((e,t)=>(0,s.jsx)(`li`,{children:d(e)},t))},`u-${e}`));continue}if(/^\d+\.\s+/.test(r)){let r=[];for(;e<t.length&&/^\d+\.\s+/.test(t[e].trim());)r.push(t[e++].trim().replace(/^\d+\.\s+/,``));n.push((0,s.jsx)(`ol`,{children:r.map((e,t)=>(0,s.jsx)(`li`,{children:d(e)},t))},`o-${e}`));continue}let a=[];for(;e<t.length&&t[e].trim()&&!/^(#{1,4})\s+|^-\s+|^\d+\.\s+/.test(t[e].trim());)a.push(t[e++].trim());n.push((0,s.jsx)(`p`,{children:d(a.join(` `))},`p-${e}`))}return n}function p(){return c.map(({slug:e})=>({slug:e}))}async function m({params:e}){let{slug:t}=await e,n=c.findIndex(e=>e.slug===t);if(n<0)return(0,s.jsxs)(`main`,{className:`case-not-found`,children:[(0,s.jsx)(`h1`,{children:`Case study not found.`}),(0,s.jsx)(`a`,{href:`/#projects`,children:`Return to projects`})]});let a=c[n],o=l[n],d=Array.from(o.matchAll(/^###\s+(.+)$/gm),e=>e[1]),p=c[n-1],m=c[n+1];return(0,s.jsxs)(`main`,{className:`case-page`,children:[(0,s.jsxs)(`header`,{className:`case-page-header`,children:[(0,s.jsxs)(`a`,{href:`/`,className:`brand`,children:[(0,s.jsx)(`span`,{className:`monogram`,children:`NC`}),(0,s.jsxs)(`span`,{children:[(0,s.jsx)(`strong`,{children:`Nishkarsh Chaudhary`}),(0,s.jsx)(`small`,{children:`Technical Project Coordinator`})]})]}),(0,s.jsxs)(`a`,{href:`/`,className:`case-back`,children:[(0,s.jsx)(r,{}),` Back to portfolio`]})]}),(0,s.jsxs)(`div`,{className:`case-shell`,children:[(0,s.jsxs)(`article`,{className:`case-document`,children:[(0,s.jsxs)(`p`,{className:`section-label`,children:[`CASE STUDY / `,a.number]}),f(o),(0,s.jsx)(`aside`,{className:`case-note`,children:`Selected details are generalized to respect client and product confidentiality.`}),(0,s.jsxs)(`nav`,{className:`case-next`,"aria-label":`Other case studies`,children:[p?(0,s.jsxs)(`a`,{href:`/case-studies/${p.slug}`,children:[(0,s.jsx)(`small`,{children:`Previous`}),(0,s.jsxs)(`span`,{children:[`← `,p.title]})]}):(0,s.jsx)(`span`,{}),m&&(0,s.jsxs)(`a`,{href:`/case-studies/${m.slug}`,children:[(0,s.jsx)(`small`,{children:`Next`}),(0,s.jsxs)(`span`,{children:[m.title,` `,(0,s.jsx)(i,{})]})]})]})]}),(0,s.jsxs)(`aside`,{className:`case-toc`,children:[(0,s.jsx)(`p`,{children:`TABLE OF CONTENTS`}),(0,s.jsx)(`nav`,{"aria-label":`Case study contents`,children:d.map((e,t)=>(0,s.jsxs)(`a`,{href:`#${u(e)}`,children:[(0,s.jsx)(`span`,{children:String(t+1).padStart(2,`0`)}),e]},e))}),(0,s.jsxs)(`a`,{className:`case-toc-back`,href:`/case-studies`,children:[(0,s.jsx)(r,{}),` Back to case studies`]})]})]})]})}export{m as default,p as generateStaticParams};